  ...
  return <>
      <div id="left-bg" className="d-flex flex-column flex-shrink-0 p-3  " style={{ height:"100vh"}} >
        ...
        <ul className="nav nav-pills flex-column mb-auto">
          ...
          <li>
          <NavLink to="/Creat-Post" className={`nav-link text-white ${(e)=>{ return e.isActive ? 'active':""}}`}>
              <svg
                className="bi pe-none me-2"
                width="16"
                height="16"
           ...
           <li>
          <NavLink to="/Fetch" className={`nav-link text-white ${(e)=>{ return e.isActive ? 'active':""}}`}>
              <svg
                className="bi pe-none me-2"
                width="16"
                height="16"
